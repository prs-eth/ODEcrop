...
def parse_args():
    ...
    parser.add_argument('-nm', "--name", default='MS_wo', type=str, help="name")
...
def main(
    ...
    for epoch in range(start_epoch, epochs):
        ...
        print("\nEpoch {}".format(epoch))
        print("train")
        train_epoch(traindataloader, network, optimizer, loss, loss_local_1, loss_local_2, loggers=(logger,vizlogger), lambda_1=lambda_1,lambda_2=lambda_2,lambda_0=lambda_0, stage=stage)
#        print("test")
#        test_epoch(testdataloader, network, optimizer, loss, loss_local_1, loss_local_2, loggers=(logger,vizlogger), lambda_1=lambda_1,lambda_2=lambda_2,lambda_0=lambda_0, stage=stage)
...
def test_epoch(dataloader, network, optimizer, loss, loss_local_1, loss_local_2, loggers, lambda_1,lambda_2,lambda_0, stage):
    logger, vizlogger = loggers    
    logger.set_mode("train")
    mean_loss_glob = 0.
    mean_loss_local_1 = 0.
