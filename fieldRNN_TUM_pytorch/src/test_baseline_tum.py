...
def parse_args():
    ...
    parser.add_argument('-s', "--snapshot", default='/home/pf/pfstaff/projects/ozgur_deep_filed/multi_stage/trained_models_sota_baselines_L/baseline_tum_R2_gru_4_0.001_6_64_2_0.1_0.5_0.0001_1_labelsC.csv_0_model.pth', type=str, help="load weights from snapshot")
...
def main(
    ...
    #Define the model
    if model_type == 'fcn':
        network = FCN_CRNN(fcn_input_size=(testdataset.max_obs,4,24,24), crnn_input_size=(testdataset.max_obs,256,24//4,24//4), crnn_model_name='clstm', 
