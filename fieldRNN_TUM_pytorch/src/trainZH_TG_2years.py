...
def parse_args():
    ...
    parser.add_argument('-c', "--checkpoint_dir", default='trained_models_ZH_TG', type=str, help="directory to save checkpoints")
    ...
    parser.add_argument('-nm', "--name", default='debug_2', type=str, help="name")
...
def main(
    ...
    traindataset = Dataset("/cluster/scratch/tmehmet/train_set_24X24_debug.hdf5", 0., 'all')
    testdataset =  Dataset_eval("/cluster/scratch/tmehmet/TG_expYear18.hdf5", 0., 'all')    
