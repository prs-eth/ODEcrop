...
if __name__=="__main__":
    ...
    dataset = ijgiDataset(datadir, tileids="tileids/train_fold0.tileids")
    
    gt_colors_r = [0, 0.25, 0.5,1]*5
    gt_colors_g = [0, 0.25, 0.5, 1]*5
    gt_colors_b = [0, 0.25, 0.5,1]*5
    ...
    for j in range(100):
        x = dataset[j][0]
        y = dataset[j][1]
        y_r = np.zeros([48,48,1])
        y_g = np.zeros([48,48,1])
        y_b = np.zeros([48,48,1])
