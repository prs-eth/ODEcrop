...
from models.TransformerModel import TransformerModel2    
from models.TransformerModel import TransformerModel3 
...
class model_GT(torch.nn.Module):
    def __init__(self, nclasses=36, num_classes_l1=6, num_classes_l2=20, s1_2_s3=None, s2_2_s3=None, transformer_type=1):
        ...
        if transformer_type==1:
            ...
            self.transformer = TransformerModel2(input_dim=nclasses, sequencelength=3,
                               d_model=128, d_inner=256,
                               n_layers=3, n_head=8, dropout=0.4, 
                               num_classes=nclasses, num_classes_l1=num_classes_l1, num_classes_l2=num_classes_l2)                

        elif transformer_type==3:
            self.transformer = TransformerModel3(input_dim=nclasses, sequencelength=3,
                               d_model=64, d_inner=256,
                               n_layers=3, n_head=8,
                               dropout=0.4, num_classes=nclasses)
