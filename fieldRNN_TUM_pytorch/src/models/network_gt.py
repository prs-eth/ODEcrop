...
class model_GT(torch.nn.Module):
    def __init__(self, nclasses=36, s1_2_s3=None, s2_2_s3=None):
...
#        self.rnn2 = torch.nn.RNNCell(self.hidden_dim, self.hidden_dim, nonlinearity='relu')
        ...
        #self.rnn1 = torch.nn.GRUCell(self.hidden_dim, self.hidden_dim)
...
#        hidden1 = self.rnn1.forward( hidden1, hidden)
#        hidden2 = self.rnn1.forward( hidden2, hidden1)
#        hidden3 = self.rnn1.forward( hidden3, hidden2)  
