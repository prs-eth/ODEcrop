...
def parse_args():
    ...
    parser.add_argument('-c', "--checkpoint_dir", default='trained_models_augmented', type=str, help="directory to save checkpoints")
    ...
    parser.add_argument('-nm', "--name", default='debug_augmented', type=str, help="name")
    parser.add_argument('-da', "--data_aug", default=0, type=int, help="data_aug")    
