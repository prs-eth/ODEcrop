...
python run_models.py --niters 55 -n 300000 -validn 60000 --ode-rnn --ode-method dopri5 --random-seed 6001 --num-search 13 --num-seeds 2 --rnn-cell gru --optimizer adam --hparams lr
