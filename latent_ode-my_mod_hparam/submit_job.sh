...
#python run_models.py --niters 60 -n 300000 -validn 60000 --ode-rnn --ode-method dopri5 --random-seed 6001 --num-search 1 --num-seeds 3 --rnn-cell gru --optimizer adamax
