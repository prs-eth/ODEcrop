...
def parse_args():
    ...
    parser.add_argument('-s', "--snapshot", default='./trained_models_multistage_4paper/debug_MS_8_0.001_6_64_2_0.1_0.5_0.0001_5_labels.csv_0_model.pth', type=str, help="load weights from snapshot")
...
def main(
    ...
    network_gt = model_GT(nclasses, s1_2_s3, s2_2_s3)
    ...
    if snapshot is not None:        
        resume(snapshot,model=network, optimizer=None)
