import numpy as np
import torch.nn
from utils.dataset_course import Dataset
from utils.dataset_eval_course import Dataset_eval
...
def parse_args():
    ...
    parser.add_argument('-nm', "--name", default='debug_course_label_0', type=str, help="name")
...
def main(
    ...
    traindataset = Dataset("/cluster/scratch/tmehmet/train_set_24X24_debug.hdf5", 0., 'train')
