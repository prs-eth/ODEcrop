...
import os
from eval_multi_stage_baseline_1 import  evaluate_fieldwise
...
def parse_args():
    ...
    parser.add_argument('-c', "--checkpoint_dir", default='trained_models_2', type=str, help="directory to save checkpoints")
...
def main(
    ...
    traindataset = Dataset("/cluster/scratch/tmehmet/train_set_24X24_debug.hdf5", 0., 'train', False)
    testdataset =  Dataset("/cluster/scratch/tmehmet/train_set_24X24_debug.hdf5", 0., 'test', True)    
    
    nclasses = traindataset.n_classes_local_1
    #nclasses = 125
