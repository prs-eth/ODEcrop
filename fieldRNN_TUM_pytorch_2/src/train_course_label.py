...
from eval_course import evaluate, evaluate_fieldwise
...
def parse_args():
    ...
    parser.add_argument('-s', "--snapshot", default='./trained_models_multistage/debug_course_label_1_model.pth', type=str, help="load weights from snapshot")
    ...
    parser.add_argument('-nm', "--name", default='debug_course_label_1', type=str, help="name")
