...
from lib.training import construct_and_train_model


# Generative model for noisy data based on ODE
parser = argparse.ArgumentParser('Latent ODE')
parser.add_argument('-n',  type=int, default=10e9, help="Size of the dataset")
...
parser.add_argument('--num-seeds', type=int, default=2, help="Number of runs to average from. Default=3")
...
#import wandb
wandb.init(project="odecropclassification",config=args, sync_tensorboard=False, entity="cropteam", group=args.dataset)
