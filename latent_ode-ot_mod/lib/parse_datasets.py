...
def parse_datasets(args, device):
    ...
    if dataset_name == "crop":
        ...
        root = r'data/Crops'
        scratch_root1 = r'/scratch/tmehmet/ODEcrop/Crops/'
        scratch_root2 = r'/cluster/scratch/tmehmet/ODEcrop/'
        ...
        if list_form:
            ...
            if automatic_batching:
                ...
                test_dataloader = FastTensorDataLoader(test_data, batch_size=test_batch_size, shuffle=False, early_prediction=early_prediction)#max 26
