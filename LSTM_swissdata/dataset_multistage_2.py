...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, path, t=0.9, mode='all', eval_mode=False, fold=None, gt_path='labelsC.csv'):
        ...
        #self.label_list_glob = [0.,2,7,10,15,16,18,21,23,34,58,60,62,63,64]
...
if __name__=="__main__":
    ...
    traindataset = Dataset("/home/pf/pfstaff/projects/ozgur_deep_filed/data_crop_CH/train_set_24x24_debug.hdf5", 0.,'all')
...
#
    ...
    class_labels = np.unique(traindataset.label_list_glob)
    print(class_labels)
    class_names = np.unique(traindataset.label_list_glob_name)
    print(class_names)
