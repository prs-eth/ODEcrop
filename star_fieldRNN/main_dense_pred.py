...
from model_indRNN import model_indRNN_dense as indRNN
...
#Define model
#model = indRNN(input_size=input_channels, output_size=n_classes, nhidden=110, nlayers=15, dropout=args.dropout)
#model = STAR(input_dim=input_channels, hidden_dims=110, nclasses=n_classes, num_rnn_layers=6, dropout=0, bidirectional=False,use_batchnorm=False, use_layernorm=False)
model = GRU(input_dim=input_channels, hidden_dims=110, nclasses=n_classes, num_rnn_layers=4, dropout=0, bidirectional=False,use_batchnorm=False, use_layernorm=False)
