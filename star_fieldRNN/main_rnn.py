...
from TCN.fieldRNN.model import TCN
import numpy as np
import argparse
...
#model =  GRU(input_dim=input_channels, hidden_dims=110, nclasses=23, num_rnn_layers=1, dropout=0.0, bidirectional=False, use_batchnorm=False, use_layernorm=False)
model = STAR(input_dim=input_channels, hidden_dims=110, nclasses=n_classes, num_rnn_layers=6, 
