...
from model_indRNN import model_indRNN as indRNN
import numpy as np
import argparse
...
model = indRNN(input_size=input_channels, output_size=n_classes, nhidden=110, nlayers=4, dropout=args.dropout)

model_parameters = filter(lambda p: p.requires_grad, model.parameters())
params = sum([np.prod(p.size()) for p in model_parameters])
print('Num params (K): ', params//1000)
